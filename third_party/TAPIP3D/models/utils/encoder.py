...
class Encoder(nn.Module):
    ...
    def __init__(self,
        ...
        super().__init__()
        assert backbone in ["resnet50", "resnet18", "clip", "cotracker_cnn"]
        ...
        elif backbone == "cotracker_cnn":
            self.backbone, self.normalize = load_cotracker_cnn()
        elif backbone.startswith('dinov2'):
            assert backbone in [
                "dinov2_vits14", "dinov2_vitb14", "dinov2_vitl14", "dinov2_vitg14",
                "dinov2_vits14_reg", "dinov2_vitb14_reg", "dinov2_vitl14_reg", "dinov2_vitg14_reg"
            ], f"Invalid DINOv2 model name: {backbone}"
            self.backbone, self.normalize = load_dinov2(model_name=backbone)
